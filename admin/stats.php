...
<body>
                ...
                <div class="">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                <h4 class="page-title">Add Stats</h4><br>
                            </div>
                            ...
                            <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post"
                                ...
                                <div class="form-group mb-4">
                                    <label class="col-md-12 p-0">Years of Presence:</label>
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="number" name="experience" id="experience"
                                            placeholder="Enter Years of Presence" required
                                            class="form-control p-0 border-0">
                                    </div>
                                </div>
                                <div class="form-group mb-4">
                                    <label class="col-md-12 p-0"> Workers :</label>
                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="number" name="workers" id="workers"
                                            placeholder="Enter the Number of Workers" required
                                            class="form-control p-0 border-0">
                                    </div>
                                </div>
    ...
    <!-- footer -->
    <!-- ============================================================== -->
    <footer class="footer text-center"> 2024 © DaCentric Technologies - <a
